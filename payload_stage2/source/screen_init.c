...
void regSet()
{
    ...
    *((volatile uint32_t*)0x1FFFFFFD) = 0;
    *((volatile uint32_t*)0x1FFFFFF8) = 0;
    ...
    *((volatile uint32_t*)0x10202240) = 0xFF;
    *((volatile uint32_t*)0x10202244) = 0x1023E;
   
    *((volatile uint32_t*)0x10202A40) = 0xFF;
    ...
    *((volatile uint32_t*)0x1040056c) = 0x18300000 + 0x46500;
